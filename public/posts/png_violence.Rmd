...
Given that across all three elections, the election periods are roughly similar, we cam facet our plot by year and compare how violent incidents relate with the onset of the election across 2002, 2007, and 2012. 
...
map <- 
  ...
  labs(x = "Longitude", 
       y = "Latitude", 
       title = "Election-related violence across the 2002, 2007, and 2012 election periods")
  theme_minimal()  
...
```{r, warning=FALSE, message=FALSE, results="asis",include=F}
