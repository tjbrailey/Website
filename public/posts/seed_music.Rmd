...
eg <- paste0(here::here(), "/content/posts/gyzjsgsfpz awnkbzyvho.png")
basic_melody <- paste0(here::here(), "/content/posts/basic_melody .png")
full_melody <- paste0(here::here(), "/content/posts/full_melody.png")
```
...
```{r}
basic_melody <- readPNG(basic_melody)
basic_melody
```
...
```{r}
full_melody <- readPNG(full_melody)
full_melody
```
